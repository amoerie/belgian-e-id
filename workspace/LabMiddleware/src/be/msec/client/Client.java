...
public class Client {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			//2. Send PIN
			//class: I want to talk to you as a identity card
			//instruction
			//param1
			//param2
			//data
			...
			System.out.println(r);
			//getBytes() Get raw bytes <-- complete response
			//getData() Get data bytes <--  get only data (you must still remove the bytes)
			//getSW() Get status reponse
			//0x9000 everything was going well <-- alway new message number
